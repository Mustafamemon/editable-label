...
var EditableLabel = function EditableLabel(props) {
  ...
  var _useState3 = (0, _react.useState)(props.initialValue),
      _useState4 = _slicedToArray(_useState3, 2),
      value = _useState4[0],
      setValue = _useState4[1];

  var _useState5 = (0, _react.useState)(props.initialValue),
      _useState6 = _slicedToArray(_useState5, 2),
      previous = _useState6[0],
      setPrevious = _useState6[1];
  ...
  var renderLabel = function renderLabel() {
    if (props.isWebsite) return _jsx('a', {
      href: '#',
      onClick: function onClick(e) {
        e.preventDefault();
        setView('text');
      }
    }, void 0, value);else return _jsx('span', {
  ...
  var renderInput = function renderInput() {
    return _jsx('div', {}, void 0, _react2.default.createElement('input', {
  ...
  return _jsx('div', {}, void 0, _jsx('h5', {}, void 0, props.heading, props.isEditIcon ? _jsx('span', {
    className: 'edit-icon',
    onClick: function onClick() {
      if (view === 'label') {
        setView('text');
    ...
    href: { value: value }
  }, void 0, _ref2)) : null, _jsx('div', {
    className: 'pt-6'
  }, void 0, _jsx('h6', {}, void 0, view === 'label' ? renderLabel() : renderInput()))));
};
...
EditableLabel.propTypes = {
  ...
  disableKeys: _propTypes2.default.bool,
  heading: _propTypes2.default.string,
  isWebsite: _propTypes2.default.bool,
  isEditIcon: _propTypes2.default.bool
};
...
module.exports = __webpack_require__(/*! F:\editable-label\src/index.js */"./src/index.js");
